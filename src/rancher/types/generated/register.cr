...
class Rancher::Register < Rancher::Object
  ...
  # key => {"type" => "string", "description" => nil, "create" => true, "update" => false, "nullable" => true, "required" => true, "readOnCreateOnly" => false, "maxLength" => 255}
  @[JSON::Field(key: "key")]
  property! key : String
  ...
  # resourceData => {"type" => "map[json]", "description" => nil, "create" => true, "update" => true, "readOnCreateOnly" => false}
  # UNSUPPORTED
  ...
  # accessKey => {"type" => "string", "description" => nil, "create" => false, "update" => false, "readOnCreateOnly" => false}
  @[JSON::Field(key: "accessKey")]
  property! access_key : String

  # secretKey => {"type" => "string", "description" => nil, "create" => false, "update" => false, "readOnCreateOnly" => false}
