...
class Rancher::ExternalHandler < Rancher::Object
  ...
  # priority => {"type" => "int", "description" => nil, "create" => true, "update" => true, "nullable" => true, "readOnCreateOnly" => false, "maxLength" => 255}
  ...
  # processConfigs => {"type" => "array[externalHandlerProcessConfig]", "description" => nil, "create" => true, "update" => false, "required" => true, "readOnCreateOnly" => false}
  @[JSON::Field(key: "processConfigs")]
  property! process_configs : Array(ExternalHandlerProcessConfig)

  # retries => {"type" => "int", "description" => nil, "create" => true, "update" => true, "nullable" => true, "readOnCreateOnly" => false, "min" => 1}
  @[JSON::Field(key: "retries")]
  property! retries : Int32

  # timeoutMillis => {"type" => "int", "description" => nil, "create" => true, "update" => true, "nullable" => true, "readOnCreateOnly" => false, "min" => 1000}
  @[JSON::Field(key: "timeoutMillis")]
  property! timeout_millis : Int32
end
