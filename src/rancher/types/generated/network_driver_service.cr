...
class Rancher::NetworkDriverService < Rancher::Object
  ...
  # networkDriver => {"type" => "networkDriver", "description" => nil, "create" => true, "update" => true, "required" => true, "readOnCreateOnly" => false}
  @[JSON::Field(key: "networkDriver")]
  property! network_driver : NetworkDriver
end
