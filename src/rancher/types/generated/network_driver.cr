...
class Rancher::NetworkDriver < Rancher::Object
  ...
  # defaultNetwork => {"type" => "defaultNetwork", "description" => nil, "create" => true, "update" => false, "readOnCreateOnly" => false}
  @[JSON::Field(key: "defaultNetwork")]
  property! default_network : DefaultNetwork

  # cniConfig => {"type" => "map[json]", "description" => nil, "create" => true, "update" => false, "readOnCreateOnly" => false}
  # UNSUPPORTED

  # networkMetadata => {"type" => "map[json]", "description" => nil, "create" => true, "update" => false, "readOnCreateOnly" => false}
  # UNSUPPORTED
end
