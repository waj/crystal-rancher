...
class Rancher::ScheduledUpgrade < Rancher::Object
  ...
  # stackId => {"type" => "reference[stack]", "description" => nil, "create" => false, "update" => false, "nullable" => true, "readOnCreateOnly" => false, "maxLength" => 255}
  # UNSUPPORTED

  # started => {"type" => "date", "description" => nil, "create" => false, "update" => false, "nullable" => true, "readOnCreateOnly" => false, "maxLength" => 255}
  @[JSON::Field(key: "started")]
  property! started : Time

  # state => {"type" => "enum", "description" => nil, "create" => false, "update" => false, "readOnCreateOnly" => false, "maxLength" => 128, "options" => ["done", "removed", "removing", "requested", "running", "scheduled", "scheduling"]}
