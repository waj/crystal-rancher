...
class Rancher::BackupTarget < Rancher::Object
  ...
  # name => {"type" => "string", "validChars" => "a-zA-Z0-9_.-", "description" => nil, "create" => true, "update" => true, "required" => true, "readOnCreateOnly" => false, "minLength" => 1, "maxLength" => 255}
  @[JSON::Field(key: "name")]
  ...
  # nfsConfig => {"type" => "nfsConfig", "description" => nil, "create" => true, "update" => false, "nullable" => true, "readOnCreateOnly" => false}
  @[JSON::Field(key: "nfsConfig")]
  property! nfs_config : NfsConfig
end
