...
class Rancher::LaunchConfig < Rancher::Object
  ...
  # drainTimeoutMs => {"type" => "int", "description" => nil, "create" => true, "update" => true, "readOnCreateOnly" => false, "default" => 0}
  @[JSON::Field(key: "drainTimeoutMs")]
  property! drain_timeout_ms : Int32
end
