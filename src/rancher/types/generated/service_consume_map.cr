...
class Rancher::ServiceConsumeMap < Rancher::Object
  ...
  # consumedService => {"type" => "string", "description" => nil, "create" => false, "update" => false, "nullable" => true, "readOnCreateOnly" => false, "maxLength" => 255}
  @[JSON::Field(key: "consumedService")]
  property! consumed_service : String

  # consumedServiceId => {"type" => "reference[service]", "description" => nil, "create" => false, "update" => false, "nullable" => true, "readOnCreateOnly" => false, "maxLength" => 255}
  # UNSUPPORTED
  ...
  # ports => {"type" => "array[string]", "description" => nil, "create" => false, "update" => false, "nullable" => true, "required" => true, "readOnCreateOnly" => false}
