...
class Rancher::ExternalServiceEvent < Rancher::Object
  ...
  # service => {"type" => "json", "description" => nil, "create" => false, "update" => false, "required" => true, "readOnCreateOnly" => false}
  # UNSUPPORTED

  # environment => {"type" => "json", "description" => nil, "create" => false, "update" => false, "readOnCreateOnly" => false}
  # UNSUPPORTED
end
