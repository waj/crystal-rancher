...
class Rancher::RegistryCredential < Rancher::Object
  ...
  # publicValue => {"type" => "string", "description" => nil, "create" => true, "update" => true, "nullable" => true, "readOnCreateOnly" => false, "maxLength" => 4096}
  @[JSON::Field(key: "publicValue")]
  property! public_value : String

  # registryId => {"type" => "reference[registry]", "description" => nil, "create" => true, "update" => false, "required" => true, "readOnCreateOnly" => false, "maxLength" => 255}
  # UNSUPPORTED
  ...
  # secretValue => {"type" => "password", "description" => nil, "create" => true, "update" => true, "nullable" => true, "readOnCreateOnly" => true, "maxLength" => 4096}
