...
class Rancher::AccountLink < Rancher::Object
  ...
  # external => {"type" => "boolean", "description" => nil, "create" => false, "update" => false, "nullable" => true, "readOnCreateOnly" => false, "maxLength" => 255}
  ...
  # linkedAccount => {"type" => "string", "description" => nil, "create" => false, "update" => false, "nullable" => true, "readOnCreateOnly" => false, "maxLength" => 255}
  @[JSON::Field(key: "linkedAccount")]
  property! linked_account : String

  # linkedRegion => {"type" => "string", "description" => nil, "create" => false, "update" => false, "nullable" => true, "readOnCreateOnly" => false, "maxLength" => 255}
  @[JSON::Field(key: "linkedRegion")]
  property! linked_region : String
  ...
  # linkedAccountUuid => {"type" => "string", "description" => nil, "create" => false, "update" => false, "readOnCreateOnly" => false, "default" => false}
  @[JSON::Field(key: "linkedAccountUuid")]
  property! linked_account_uuid : String
end
