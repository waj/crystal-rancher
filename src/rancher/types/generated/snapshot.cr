...
class Rancher::Snapshot < Rancher::Object
  ...
  # volumeId => {"type" => "reference[volume]", "description" => nil, "create" => false, "update" => false, "required" => true, "readOnCreateOnly" => false, "maxLength" => 255}
  # UNSUPPORTED
