...
class Rancher::ComposeProject < Rancher::Object
  ...
  # templates => {"type" => "map[string]", "description" => nil, "create" => true, "update" => false, "nullable" => true, "required" => true, "readOnCreateOnly" => false}
  # UNSUPPORTED
