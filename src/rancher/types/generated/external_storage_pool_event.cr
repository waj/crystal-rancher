...
class Rancher::ExternalStoragePoolEvent < Rancher::Object
  ...
  # hostUuids => {"type" => "array[string]", "description" => nil, "create" => false, "update" => false, "readOnCreateOnly" => false}
  @[JSON::Field(key: "hostUuids")]
  property! host_uuids : Array(String)

  # storagePool => {"type" => "storagePool", "description" => nil, "create" => false, "update" => false, "required" => true, "readOnCreateOnly" => false}
  @[JSON::Field(key: "storagePool")]
  property! storage_pool : StoragePool
end
