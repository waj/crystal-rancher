...
class Rancher::InstanceLink < Rancher::Object
  ...
  # linkName => {"type" => "string", "description" => nil, "create" => false, "update" => false, "nullable" => true, "readOnCreateOnly" => false, "maxLength" => 255}
  ...
  # targetInstanceId => {"type" => "reference[instance]", "description" => nil, "create" => false, "update" => true, "nullable" => true, "readOnCreateOnly" => false, "maxLength" => 255}
  # UNSUPPORTED
  ...
  # ports => {"type" => "array[json]", "description" => nil, "create" => false, "update" => false, "readOnCreateOnly" => false}
  # UNSUPPORTED
end
