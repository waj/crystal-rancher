...
class Rancher::ExternalDnsEvent < Rancher::Object
  ...
  # serviceName => {"type" => "string", "description" => nil, "create" => false, "update" => false, "readOnCreateOnly" => false}
  @[JSON::Field(key: "serviceName")]
  property! service_name : String

  # stackName => {"type" => "string", "description" => nil, "create" => false, "update" => false, "readOnCreateOnly" => false}
  @[JSON::Field(key: "stackName")]
  property! stack_name : String

  # fqdn => {"type" => "string", "description" => nil, "create" => false, "update" => false, "readOnCreateOnly" => false}
  @[JSON::Field(key: "fqdn")]
