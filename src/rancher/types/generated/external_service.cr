...
class Rancher::ExternalService < Rancher::Object
  ...
  # externalIpAddresses => {"type" => "array[string]", "description" => nil, "create" => true, "update" => true, "nullable" => true, "readOnCreateOnly" => false}
  @[JSON::Field(key: "externalIpAddresses")]
  property! external_ip_addresses : Array(String)

  # hostname => {"type" => "string", "description" => nil, "create" => true, "update" => true, "nullable" => true, "readOnCreateOnly" => false}
